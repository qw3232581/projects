...
<script>
    ...
    function fqBrand(brandId) {
        window.location='/searchProduct?keyword=${keyword}&brandId='+brandId+'&sort=${sort2}&pa=${pa}&pb=${pb}';
    }

    //过滤价格 a起点 b终点
    function fqPrice(a,b) {
        window.location='/searchProduct?keyword=${keyword}&pa='+a+'&pb='+b+'&sort=${sort2}&brandId=${brandId}';
    }

    function removeCondition(key) {
        if (key=='品牌'){
            window.location='/searchProduct?keyword=${keyword}&pa=${pa}&pb=${pb}&sort=${sort2}';
        }
        if (key=='价格'){
            window.location='/searchProduct?keyword=${keyword}&sort=${sort2}&brandId=${brandId}';
        }
    }
</script>
...
<div id="J_searchWrap" class="w">
                ...
                <c:if test="${fn:length(map) != 0 }">
                    <div class="sl-b-selected J_brandSelected">
                        ...
                        <c:forEach items="${map }" var="m">
                            <a title="${m.value}"  href="javascript:removeCondition('${m.key}');" class="crumb-select-item">
                                <b>${m.key }：</b>
                                <em>${m.value }</em><i></i>
                            </a>
                        </c:forEach>
    ...
    <div id="J_boxSearch" style="display:none;">
            ...
            <div id="J_main" class="g-main2 left2right">
                        ...
                        <div id="J_filter" class="filter">
                            <div class="f-line top">
                                ...
                                <div class="f-sort">
                                    ...
                                    <a href="javascript:searchKeyword('${sort}','1')" class="">价格<i></i></a>
                                ...
                                <div id="J_topPage" class="f-pager"><span class="fp-text">
                                    <b>${page.pageNum}</b><em>/</em><i>${page.pages}</i></span>
                                    <a class="fp-prev" onclick="searchKeyword('${sort2}',${page.pageNum-1})" href="javascript:;">&lt;</a>
                                    <c:if test="${page.pageNum+1 > page.pages}">
                                        <a class="fp-next" href="javascript:;">&gt;</a>
                                    </c:if>
                                    <c:if test="${page.pageNum+1 <= page.pages}">
                                        <a class="fp-next"  onclick="searchKeyword('${sort2}',${page.pageNum+1})" href="javascript:;">&gt;</a>
                                    </c:if>
                                </div>

                                <div class="f-result-sum">共<span id="J_resCount" class="num">${page.total}</span>件商品</div>
                                <span class="clr"></span>
                            </div>
                                    ...
                                    <div id="store-selector" class="">
                                        ...
                                        <div class="content">
                                            <div data-widget="tabs" class="m JD-stock">
                                                <div class="mt">
                                                    <ul class="tab">
                                                        <li data-index="0" data-widget="tab-item" class=""><a href="javascript:;" class="hover" title="北京"><em>北京</em><i></i></a></li>
                                                        <li data-index="1" data-widget="tab-item" style="" class=""><a href="javascript:;" class="" title="朝阳区"><em>朝阳区</em><i></i></a></li>
                                                        <li data-index="2" data-widget="tab-item" style="" class="curr"><a href="javascript:;" class="" title="三环以内"><em>三环以内</em><i></i></a></li>
                                                ...
                                                <ul class="area-list"><li><a href="javascript:;" data-value="72">朝阳区</a></li>
                                    ...
                                    <li data-sku="1711416562" class="gl-item">
                                        <div class="gl-i-wrap">
                                            <div class="p-img">
                                                ...
                                                <%--<a href="javascript:;" onclick="window.open('/product/showProductDetail?productId=${product.id}')" style="position: relative;">--%>
                ...
                <div class="m-aside">
                    <div class="aside-bar">
                        ...
                        <div id="J_promGoodsWrap_6" class="ab-goods" style="display: true;">
                            <div class="mt">
                                <h3>推广商品</h3>
                            </div>
                            <div class="mc"></div>
