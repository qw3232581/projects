...
<div class="w main">
	<div class="m m3 msop">
        <div class="mt" id="success_tittle"><s class="icon-succ02"></s><h3 class="ftx-02">感谢您，订单提交成功！</h3></div>
		<div class="mc" id="success_detail">	
		    <ul class="list-order">
			    <li class="li-st">
					<div class="fore1">订单号：<a href="javascript:void(0)">${orderId}</a></div>
					<!-- 货到付款 -->
					<div class="fore2">货到付款：<strong class="ftx-01">${orderPrice}元</strong></div>
					<div class="fore3">新巴巴快递 &nbsp; 送货时间: 预计 2016-08-25 14:49:39 送达&nbsp;</div>
				</li>
			</ul>
		<!-- 在线支付按钮  -->
        <div id="bookDiv"></div>
