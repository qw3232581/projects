...
</div><div class="sm sm2 fore4"  data-widget="tab-item" data-tag="57" clstag="homepage|keycount|home2013|18f">
  <div class="smt">
    <h3>手机通讯</h3>
  </div>
  <div class="smc" data-widget="tab-content">
...
</div><div class="sm sm2 fore5"  data-widget="tab-item" data-tag="58" clstag="homepage|keycount|home2013|18g">
  <div class="smt">
    <h3>汽车五金</h3>
  </div>
  <div class="smc" data-widget="tab-content">
...
<!-- 绑定显示数据到页面 -->
<script type="text/javascript">
pageConfig.DATA_Tabs = ${indexItemADList}</script>
<script type="text/javascript">
