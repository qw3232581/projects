    ...
    $(function () {
        ...
        $('#grid').datagrid({
            ...
            onAfterEdit: function (rowIndex, rowData, changes) {
                $.post("${pageContext.request.contextPath}/subareaAction_updateFunction", rowData, function (data) {
                    if (data) {
        ...
        $("#btn").click(function () {
            var formJsonData = $("#searchSubareaForm").serializeJson();

            $("#grid").datagrid("load", formJsonData);
...
<div class="easyui-window" title="分区添加修改" id="addSubareaWindow" collapsible="false" minimizable="false" maximizable="false" style="top:20px;left:200px">
    ...
    <div style="overflow:auto;padding:5px;" border="false">
        <form id="addSubareaForm" action="${pageContext.request.contextPath }/subareaAction_saveSubarea" method="post">
            <table class="table-edit" width="80%" align="center">
                ...
                <tr>
                    <td>选择区域</td>
                    <td>
                        <input class="easyui-combobox" name="region.id" data-options="valueField:'id',textField:'name',mode:'remote',
...
<div class="easyui-window" title="查询分区窗口" id="searchWindow" collapsible="false" minimizable="false" maximizable="false" style="top:20px;left:200px">
    <div style="overflow:auto;padding:5px;" border="false">
        <form id="searchSubareaForm" action="${pageContext.request.contextPath }/subareaAction_download" method="post">
            <table class="table-edit" width="80%" align="center">
                <tr class="title">
                ...
                <tr>
                    <td>省</td>
                    <td>
                        <input type="text" name="region.province"/>
                    </td>
                </tr>
                <tr>
                    <td>市</td>
                    <td>
                        <input type="text" name="region.city"/>
                    </td>
                </tr>
                <tr>
                    <td>区（县）</td>
                    <td>
                        <input type="text" name="region.district"/>
                    </td>
                </tr>
                <tr>
                    <td>定区编码</td>
