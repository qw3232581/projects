...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            $("input[name='checkcode']").blur(function () {
                if (this.value == null || this.value == "") {
                    alert("must insert checkcode")
                    return;
                }

                $.post("${pageContext.request.contextPath}/userAction_validateCheckcode", {"checkcode": this.value}, function (data) {
                    if (data) {
                        $("#checkcode_sp").html("√")
                        code_flag = true
                    } else {
        ...
        function login() {
            var code_flag2 = $("#loginform").form("validate");
            if (code_flag) {
                $("#loginform").submit();
            }
        }
        ...
        <div class="loginForm">
            <form id="loginform" name="loginform" method="post" class="niceform"
                ...
                <div id="idInputLine" class="loginFormIpt showPlaceholder" style="margin-top: 5px;">
                    <input id="loginform:idInput" type="text" name="email" class="loginFormTdIpt easyui-validatebox"
                ...
                <div class="loginFormIpt loginFormIptWiotTh" style="margin-top: 58px;">
                    ...
                    <a href="javascript:;" id="loginform:j_id19" name="loginform:j_id19" onclick="login();">
                    ...
                    <font color="red"><span id="checkcode_sp"></span></font>
...
<div style="width: 900px; height: 50px; position: absolute; text-align: left; left: 50%; top: 50%; margin-left: -450px;; margin-top: 220px;">
    <span style="color: #488ED5;">Powered By Jamayette</span>
