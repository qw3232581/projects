...
<head>
    ...
    <script type="text/javascript">
        ...
        function doSearch() {
            $('#queryDecidedzoneWindow').window("open");
        }
        ...
        $(function () {
            ...
            $("#btn").click(function () {
                var params = $("#queryDecidedzoneForm").serializeJson();
                $("#grid").datagrid('load', params);
                $("#queryDecidedzoneWindow").window('close');
            });
...
<div class="easyui-window" title="定区添加修改" id="addDecidedzoneWindow" collapsible="false" minimizable="false"
    ...
    <div style="overflow:auto;padding:5px;" border="false">
        <form id="addDecidedzoneForm" action="${pageContext.request.contextPath }/decidedzoneAction_saveDecidedzone"
              method="post">
                ...
                <tr>
                    ...
                    <td>
                        <input class="easyui-combobox" name="staff.id"
                               ...
                               url:'${pageContext.request.contextPath}/staffAction_ajaxList '"/>
                    </td>
                </tr>
                <tr height="300">
                    ...
                    <td>
                        <table id="subareaGrid" class="easyui-datagrid" border="false"
                               ...
                               data-options="url:'${pageContext.request.contextPath }/subareaAction_noAssociationList',
...
<!-- 查询定区 -->
<div class="easyui-window" title="查询定区窗口" id="queryDecidedzoneWindow" 
    ...
    <div style="overflow:auto;padding:5px;" border="false">
        <form id="queryDecidedzoneForm">
            <table class="table-edit" width="80%" align="center">
                ...
                <tr>
                    <td colspan="2">
                    <a id="btn" href="javascript:;" class="easyui-linkbutton" 
